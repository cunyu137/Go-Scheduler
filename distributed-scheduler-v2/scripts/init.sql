CREATE DATABASE IF NOT EXISTS scheduler_v2 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE scheduler_v2;
...
CREATE TABLE IF NOT EXISTS task_instances (
    ...
    status VARCHAR(32) NOT NULL COMMENT 'pending/dispatched/running/success/failed/timeout',
